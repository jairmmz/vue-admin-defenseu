        ...
        <ul ref="dropdown" @focusin="dropdownOpen = true" @focusout="dropdownOpen = false">
          <li>
            <router-link class="font-medium text-sm text-indigo-500 hover:text-indigo-600 flex items-center py-1 px-3"
              to="/settings/account" @click="dropdownOpen = false">Ajustes</router-link>
          </li>
          <li>
            <button class="font-medium text-sm text-indigo-500 hover:text-indigo-600 flex items-center py-1 px-3"
              @click="handleLogout">Salir</button>
          </li>
        </ul>
      </div>
    </transition>
