    ...
    <div
      ...
      <div class="flex w-full justify-between items-start">
        <div class="flex">
          ...
          <svg v-else-if="type === 'error'" class="w-4 h-4 shrink-0 fill-current text-rose-500 mt-[3px] mr-3"
            viewBox="0 0 16 16">
            <path
          ...
          <svg v-else-if="type === 'success'" class="w-4 h-4 shrink-0 fill-current text-emerald-500 mt-[3px] mr-3"
            viewBox="0 0 16 16">
