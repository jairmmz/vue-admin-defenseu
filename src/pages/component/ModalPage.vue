    ...
    <div class="space-y-8 mt-8">
      ...
      <div>
        ...
        <div class="flex flex-wrap items-center -m-1.5">
          ...
          <div class="m-1.5">
            <!-- Start -->
            <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white" aria-controls="basic-modal"
          ...
          <div class="m-1.5">
            <!-- Start -->
            <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white" aria-controls="scrollbar-modal"
              @click.stop="scrollbarModalOpen = true">Modal w/ Scroll Bar</button>
            <ModalBasic id="scrollbar-modal" :modalOpen="scrollbarModalOpen" @close-modal="scrollbarModalOpen = false"
                ...
                <div class="text-sm">
                  ...
                  <div class="space-y-2">
                    ...
                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
                      pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit
                      anim id est laborum.</p>
                    <p>Ullamcorper malesuada proin libero nunc consequat interdum varius sit. Nec sagittis aliquam
                      ...
                      egestas maecenas pharetra volutpat lacus laoreet non.</p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                      et dolore magna aliqua.</p>
                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
                      pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit
          ...
          <div class="m-1.5">
            ...
            <ModalCookies id="cookies-modal" :modalOpen="cookiesModalOpen" @close-modal="cookiesModalOpen = false"
      ...
      <div>
        ...
        <div class="flex flex-wrap items-center -m-1.5">
          ...
          <div class="m-1.5">
            <!-- Start -->
            <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white" aria-controls="success-modal"
          ...
          <div class="m-1.5">
            <!-- Start -->
            <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white" aria-controls="danger-modal"
          ...
          <div class="m-1.5">
            <!-- Start -->
            <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white" aria-controls="info-modal"
      ...
      <div>
        ...
        <div class="flex flex-wrap items-center -m-1.5">
          ...
          <div class="m-1.5">
            <!-- Start -->
            <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white" aria-controls="newsletter-modal"
            ...
            <ModalAction id="newsletter-modal" :modalOpen="newsletterModalOpen"
              ...
              <div class="text-center">
                ...
                <form class="flex max-w-sm m-auto">
                  ...
                  <button type="submit"
                    class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white whitespace-nowrap">Subscribe</button>
                </form>
          ...
          <div class="m-1.5">
            <!-- Start -->
            <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white" aria-controls="announcement-modal"
            ...
            <ModalAction id="announcement-modal" :modalOpen="announcementModalOpen"
              ...
              <div class="text-center">
                ...
                <div class="space-y-3">
                  ...
                  <div>
                    <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600" href="#0"
                      @click.prevent="announcementModalOpen = false">Not Now!</a>
                  </div>
                </div>
              </div>
            </ModalAction>
          ...
          <div class="m-1.5">
            <!-- Start -->
            <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white" aria-controls="integration-modal"
            ...
            <ModalAction id="integration-modal" :modalOpen="integrationModalOpen"
              ...
              <div class="text-sm mb-5">
                ...
                <div class="text-xs text-slate-500">By clicking on Allow access, you authorize Mosaic to use your
                  information in accordance with its <a class="text-indigo-500 hover:text-indigo-600" href="#0">Privacy
                    Policy</a>. You can stop it at any time on the integrations page of your Mosaic account.</div>
              </div>
              <!-- Modal footer -->
              <div class="flex flex-wrap justify-end space-x-2">
                <button class="btn-sm border-slate-200 hover:border-slate-300 text-slate-600"
          ...
          <div class="m-1.5">
            <!-- Start -->
            <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white" aria-controls="news-modal"
            ...
            <ModalBlank id="news-modal" :modalOpen="newsModalOpen" @close-modal="newsModalOpen = false">
              <div class="relative">
                ...
                <!-- Close button -->
                <button class="absolute top-0 right-0 mt-5 mr-5 text-slate-50 hover:text-white"
              ...
              <div class="p-5">
                ...
                <div class="text-sm mb-5">
                  <div class="space-y-2">
                    <p>You might not be aware of this fact, but every frame, digital video, canvas, responsive design, and
                      image often has a rectangular shape that is exceptionally precise in proportion (or ratio).</p>
                    <p>The ratio has to be well-defined to make shapes fit into different and distinct mediums, such as
                      computer, movies, television and camera screens.</p>
                  </div>
                </div>
                <!-- Modal footer -->
                <div class="flex flex-wrap justify-end space-x-2">
            ...
            <ModalBasic id="feedback-modal" :modalOpen="planModalOpen" @close-modal="planModalOpen = false"
              ...
              <div class="px-5 pt-4 pb-1">
                <div class="text-sm">
                        ...
                        <div class="flex items-center">
                          ...
                          <div class="grow">
                            <div class="flex flex-wrap items-center justify-between mb-0.5">
                              <span class="font-medium text-slate-800">Mosaic Light <span
                                  class="text-xs italic text-slate-500 align-top">Current Plan</span></span>
                    ...
                    <li>
                      <button
                        ...
                        <div class="flex items-center">
                          ...
                          <div class="grow">
                            <div class="flex flex-wrap items-center justify-between mb-0.5">
                              <span class="font-semibold text-slate-800">Mosaic Basic <span
                  ...
                  <div class="text-xs text-slate-500">Your workspace’s Mosaic Light Plan is set to $39 per month and will
                    renew on August 9, 2021.</div>
                </div>
              </div>
              <!-- Modal footer -->
              <div class="px-5 py-4">
          ...
          <div class="m-1.5">
            <!-- Start -->
            <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white" aria-controls="quick-find-modal"
