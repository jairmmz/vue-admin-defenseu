      ...
      <div>
        ...
        <div class="grid gap-5 md:grid-cols-3">
          ...
          <div>
            ...
            <div>
              <div>
                <label class="block text-sm font-medium mb-1" for="error">Error <span
                    class="text-rose-500">*</span></label>
      ...
      <div>
        ...
        <div class="flex flex-wrap items-center -m-3">
          ...
          <div class="m-3 w-32">
            ...
            <div class="flex items-center mt-5">
              <div class="form-switch">
                <input type="checkbox" id="toggle3" class="sr-only" v-model="toggle3" true-value="On" false-value="Off"
                  disabled />
