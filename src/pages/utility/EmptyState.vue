<template>
  ...
  <div class="sm:flex sm:justify-between sm:items-center mb-8">
    ...
    <div class="mb-4 sm:mb-0">
      <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Empty State ✨</h1>
    </div>
  ...
  <div class="border-t border-slate-200">
    <div class="max-w-2xl m-auto mt-16">
      ...
      <div class="text-center px-4">
        ...
        <h2 class="text-2xl text-slate-800 font-bold mb-2">Pay your bills in just a few clicks</h2>
        <div class="mb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
