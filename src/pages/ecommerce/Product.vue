<template>
  ...
  <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
    ...
    <div>
      ...
      <header class="mb-4">
        <!-- Title -->
        <h1 class="text-2xl md:text-3xl text-slate-800 font-bold mb-2">Front-End Learning: Hands-On HTML & CSS In Real Web
          Apps ✨</h1>
      ...
      <!-- Product content -->
      <div>
        <h2 class="text-xl leading-snug text-slate-800 font-bold mb-2">Overview</h2>
        <p class="mb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
          labore et dolore magna aliqua u t enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
          aliquip ex ea commodo consequat.</p>
        <p class="mb-6">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla
        ...
        <blockquote class="text-slate-800 italic mb-6">
      ...
      <!-- Reviews -->
      <div>
        <h2 class="text-xl leading-snug text-slate-800 font-bold mb-2">Featured Reviews (44)</h2>
        <ul class="space-y-5 my-6">
          <!-- Review -->
          <li>
            <div class="flex items-center mb-2">
              <img class="w-8 h-8 rounded-full mr-3" src="../../images/user-32-07.jpg" width="32" height="32"
                alt="User 07" />
              <div>
            ...
            <div class="text-sm italic">“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
              incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.”</div>
          </li>
          <!-- Review -->
          <li>
            <div class="flex items-center mb-2">
              <img class="w-8 h-8 rounded-full mr-3" src="../../images/user-32-05.jpg" width="32" height="32"
                alt="User 05" />
              <div>
                <div class="text-sm font-semibold text-slate-800 mb-1">Marija Urkjulz</div>
                <!-- Rating -->
                <div class="flex items-center space-x-2">
                  <!-- Stars -->
                  <div class="flex space-x-1">
                  ...
                  <!-- Rate -->
                  <div class="inline-flex text-sm font-medium text-amber-600">4.9</div>
                </div>
              </div>
            </div>
            <div class="text-sm italic">“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
          ...
          <li>
            <div class="flex items-center mb-2">
              <img class="w-8 h-8 rounded-full mr-3" src="../../images/user-32-03.jpg" width="32" height="32"
                alt="User 03" />
              <div>
                <div class="text-sm font-semibold text-slate-800 mb-1">Rodrigo Pantoja</div>
                <!-- Rating -->
                <div class="flex items-center space-x-2">
                  <!-- Stars -->
                  <div class="flex space-x-1">
                  ...
                  <!-- Rate -->
                  <div class="inline-flex text-sm font-medium text-amber-600">4.4</div>
                </div>
              </div>
            </div>
            <div class="text-sm italic">“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
          ...
          <li>
            <div class="flex items-center mb-2">
              <img class="w-8 h-8 rounded-full mr-3" src="../../images/user-32-04.jpg" width="32" height="32"
                alt="User 04" />
              <div>
                <div class="text-sm font-semibold text-slate-800 mb-1">Juan Johnson</div>
                <!-- Rating -->
                <div class="flex items-center space-x-2">
                  <!-- Stars -->
                  <div class="flex space-x-1">
        ...
        <div class="text-center">
          <button class="btn bg-white border-slate-200 hover:border-slate-300 text-indigo-500 hover:text-slate-600">Load
            More Reviews</button>
        </div>
      </div>
      ...
      <!-- Related -->
      <div>
        <h2 class="text-xl leading-snug text-slate-800 font-bold mb-2">Frequently Bought Together</h2>
        <ul class="space-y-8 sm:space-y-5 my-6">
          ...
          <li class="sm:flex items-center">
            <a class="block mb-4 sm:mb-0 mr-5 md:w-32 xl:w-auto shrink-0" href="#0">
              <img class="rounded-sm" src="../../images/related-product-01.jpg" width="200" height="142"
                alt="Product 01" />
            </a>
            <div class="grow">
              <a href="#0">
                <h3 class="text-lg font-semibold text-slate-800 mb-1">The Complete Front-End Development Course!</h3>
              </a>
              <div class="text-sm mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt ut.</div>
              <!-- Rating and price -->
          ...
          <li class="sm:flex items-center">
            ...
            <div class="grow">
              <a href="#0">
                <h3 class="text-lg font-semibold text-slate-800 mb-1">Web Development Ultimate Course 2021</h3>
              </a>
              <div class="text-sm mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                incididunt ut.</div>
              <!-- Rating and price -->
    ...
    <div>
      <div class="bg-white p-5 shadow-lg rounded-sm border border-slate-200 lg:w-72 xl:w-80">
        <div class="text-sm text-slate-800 font-semibold mb-3">Select a Package</div>
        <ul class="space-y-2 sm:flex sm:space-y-0 sm:space-x-2 lg:space-y-2 lg:space-x-0 lg:flex-col mb-4">
          <li>
            <button
              ...
              <div class="flex flex-wrap items-center justify-between mb-0.5">
                <span class="font-semibold text-slate-800">Essential</span>
          ...
          <li>
            <button
              class="w-full h-full text-left py-3 px-4 rounded bg-white border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
              <div class="flex flex-wrap items-center justify-between mb-0.5">
                <span class="font-semibold text-slate-800">Complete</span>
        ...
        <div class="text-xs text-slate-500 italic text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
          sed do <a class="underline hover:no-underline" href="#0">Terms</a>.</div>
      </div>
    </div>
