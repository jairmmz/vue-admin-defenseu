        ...
        <div class="mb-6 lg:mb-0">
            ...
            <form>
              <div class="space-y-4">
                ...
                <div class="text-right">
                  <button type="submit"
                    class="btn bg-white border-slate-200 hover:border-slate-300 text-indigo-500">Download Invoice</button>
                </div>
              </div>
            </form>
          </div>
          ...
          <div class="bg-white rounded border border-slate-200 p-4">
            <div
              ...
              <div class="text-sm">Enjoy a <span class="font-medium text-slate-800">20% OFF</span> discount on your next
                order 🎉</div>
        ...
        <div class="py-8 px-4 lg:px-8 2xl:px-12">
          <div class="max-w-sm mx-auto lg:max-w-none">
            ...
            <div class="space-y-6">
                ...
                <ul>
                  ...
                  <li class="flex items-center py-3 border-b border-slate-200">
                    <a class="block mr-2 xl:mr-4 shrink-0" href="#0">
                      <img class="w-16 xl:w-20" src="../../images/related-product-01.jpg" width="200" height="142"
                        alt="Product 01" />
                    </a>
                    <div class="grow">
                      <a href="#0">
                        <h4 class="text-sm font-medium text-slate-800 leading-tight">The Complete Front-End Development
                          Course!</h4>
                      </a>
                    </div>
                  ...
                  <li class="flex items-center py-3 border-b border-slate-200">
                    <a class="block mr-2 xl:mr-4 shrink-0" href="#0">
                      <img class="w-16 xl:w-20" src="../../images/related-product-02.jpg" width="200" height="142"
                        alt="Product 02" />
                    </a>
                    <div class="grow">
                      <a href="#0">
                        <h4 class="text-sm font-medium text-slate-800 leading-tight">Web Development Ultimate Course 2021
                        </h4>
                      </a>
                    </div>
                    <div class="text-sm font-medium text-slate-800 ml-2">$69</div>
                  ...
                  <li class="flex items-center py-3 border-b border-slate-200">
                    <a class="block mr-2 xl:mr-4 shrink-0" href="#0">
                      <img class="w-16 xl:w-20" src="../../images/related-product-03.jpg" width="200" height="142"
                        alt="Product 03" />
                    </a>
                    <div class="grow">
                      <a href="#0">
                ...
                <ul>
                  ...
                  <li class="flex items-center justify-between py-3 border-b border-slate-200">
                    <div class="flex items-center">
                      ...
                      <span
                        class="text-xs inline-flex whitespace-nowrap font-medium uppercase bg-slate-200 text-slate-500 rounded-full text-center px-2.5 py-1">XMAS22</span>
                    </div>
              ...
              <div class="mt-6">
                <div class="mb-4">
                  <router-link to="/ecommerce/pay" class="btn w-full bg-indigo-500 hover:bg-indigo-600 text-white">View
                    Your Order</router-link>
                </div>
                <div class="text-xs text-slate-500 italic text-center">Should you ever change your mind, we offer a
                  14-day, no-questions-asked refund policy.</div>
              </div>
