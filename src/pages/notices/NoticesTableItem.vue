    ...
    <tr>
        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
            <div class="flex items-center">
                <label class="inline-flex">
                    ...
                    <input :id="notice.id" class="form-checkbox" type="checkbox" :value="value" @change="check"
                        :checked="checked" />
                </label>
            </div>
        </td>
        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
            <div class="font-medium text-slate-800">{{ notice.title }}</div>
        </td>
        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
            <div>
        ...
        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
            <div class="flex space-x-1">
                <button @click="viewNotice(notice.id)" class="text-slate-400 hover:text-slate-500 rounded-full">
                ...
                <router-link :to="{ name: 'app.notices.edit', params: { id: notice.id }}" class="text-blue-500 hover:text-blue-700 rounded-full">
                ...
                <button @click="deleteNoticeModal(notice.id)" class="text-rose-500 hover:text-rose-600 rounded-full">
