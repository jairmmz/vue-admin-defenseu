          ...
          <div class="max-w-sm mx-auto px-4 py-8">
            ...
            <form>
              ...
              <div class="flex items-center justify-between mt-6">
                ...
                <router-link class="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3 whitespace-nowrap" to="/">Sign
                  Up</router-link>
              </div>
            </form>
            <!-- Footer -->
            <div class="pt-5 mt-6 border-t border-slate-200">
              <div class="text-sm">
                Have an account? <router-link class="font-medium text-indigo-500 hover:text-indigo-600" to="/signin">Sign
                  In</router-link>
              </div>
            </div>
          </div>
